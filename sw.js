...
self.addEventListener("message", (event) => {
  ...
  if (replyTo) {
    ...
    switch ((_a = event.data) == null ? void 0 : _a.type) {
      case "version":
        reply({ version: "0.3.3", buildHash: "395679932" });
        break;
      case "skipWaiting":
        self.skipWaiting();
        break;
