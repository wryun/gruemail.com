...
class SessionLoadViewModel extends ViewModel {
  ...
  get loadLabel() {
    ...
    if (error || client && client.loadStatus.get() === LoadStatus.Error) {
      return `Something went wrong: ${error && error.stack}.`;
    }
    if (client) {
...
class OlmWorker {
  ...
  async createOutboundOlmSession(account, newSession, theirIdentityKey, theirOneTimeKey) {
    ...
    let randomValues;
    randomValues = [
      self.crypto.getRandomValues(new Uint8Array(64))
    ];
...
function hydrogenGithubLink(t) {
  if ("3389581555") {
    ...
    }, `Hydrogen v${"0.3.3"} (${"3389581555"}) on Github`);
  } else {
...
var _workerPath = "./assets/main.3eab263f.js";
...
main(platform);
//# sourceMappingURL=index.127d2c93.js.map
